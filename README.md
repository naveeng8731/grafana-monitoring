...
🌐 Access URLs
Service	URL	Port	Description
Grafana	http://localhost:3000	3000	Dashboards and visualizations
Prometheus	http://localhost:9090	9090	Metrics scraping and querying
Alertmanager	http://localhost:9093	9093	Alert routing and notifications
Loki	http://localhost:3100	3100	Log aggregation backend
Nginx (Proxy)	http://localhost	80	Optional reverse proxy for unified access
👤 Author
Naveen G
GitHub: https://github.com/naveeng8731
...
For suggestions or contributions, feel free to open an issue or pull request.
 ...
 2f52e79 (Updated README with setup and access details)
